...
namespace Webshop.Test
{
    public class GetShoppingCartTests
    {
        ...
        public GetShoppingCartTests()
        {
            ...
            _productRepositoryMock.AddProducts(1, "Kylian Mbappé's T-shirt", (decimal)100.99);
            _productRepositoryMock.AddProducts(2, "Olivier Giroud's T-shirt", (decimal)200.49);
            _productRepositoryMock.AddProducts(3, "Bart van Hintum's T-shirt", (decimal)110.99);
            _productRepositoryMock.AddProducts(4, "Thom van Bergen's T-shirt", (decimal)160.99);
